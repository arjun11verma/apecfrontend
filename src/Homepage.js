...
class Homepage extends Component {
    ...
    componentDidMount = () => {
        ...
        firebase.database().ref("Accounts").once('value').then(function (snapshot) {
            ...
            axios.post('https://flaskserver.herokuapp.com/analyzeCustomerData', { 'data': weightedWeeklyData }).then(res => {
            ...
            var urlBoxList = [];
            axios.post('https://flaskserver.herokuapp.com/getArticleInfo', { 'country': country }).then(res => {
                var data = res.data;
                var outerDict;
                var rows = [];
                var cards = []
            ...
            axios.post('https://flaskserver.herokuapp.com/covidData', { 'country': country }).then(res => {
                var covidData = [];
                ...
                axios.post('https://flaskserver.herokuapp.com/analyzeCustomerData', { 'data': covidData }).then(res => {
                    var resData = res.data.data;
                    var calculatedData = [];
                    var topper = resData[0];
                    var divisor = 1000;
